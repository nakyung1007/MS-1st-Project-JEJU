    ...
    return (
        <div className={"h-screen w-full bg-cover bg-center relative"}>
            ...
            <div className={"fixed right-4 bottom-3 z-50"}>
                <button
                    className={
                        "bg-contain bg-center bg-no-repeat focus:outline-none z-50 " +
                        "2xl:w-24 2xl:h-24 " +
                        "xl:w-24 xl:h-24 " +
                        "lg:w-20 lg:h-20 " +
                        "md:w-16 md:h-16 " +
                    ...
                    style={{
                        backgroundImage: "url('/public/images/review.jpg')"
                    }}
                    onClick={() => window.open("https://forms.office.com/r/WuEfuqsNXe")}
                />
            </div>
        </div>
    );
